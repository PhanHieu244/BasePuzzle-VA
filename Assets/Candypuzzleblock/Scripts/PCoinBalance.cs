...
public class PCoinBalance : MonoBehaviour 
{
	...
	void OnEnable()
	{
		PCurrencyManager.OnCoinBalanceUpdated += OnCoinBalanceUpdated;	

		int coinBalance = PCurrencyManager.Instance.GetCoinBalance ();
