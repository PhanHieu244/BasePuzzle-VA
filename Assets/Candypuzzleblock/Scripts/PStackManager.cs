...
public class PStackManager : PSingleton<PStackManager> 
{
	/// <summary>
	...
	public GameObject SpawnUIScreen (string name, bool doAddToStack = true)
	{
		...
		thisScreen.transform.SetParent (PGameController.Instance.UICanvas.transform);
	...
	public void OnBackButtonPressed ()
	{
		...
		PInputManager.Instance.DisableTouchForDelay ();
	}
