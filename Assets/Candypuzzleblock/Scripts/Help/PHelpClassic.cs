...
/// Help classic.
/// </summary>
public class PHelpClassic : MonoBehaviour
{
	[SerializeField]
	...
	void StartHelp ()
	{
		GameObject firstShape = PBlockShapeSpawner.Instance.transform.GetChild (0).gameObject;
		...
		secondPosition = PGamePlay.Instance.transform.Find ("Game-Content").position;
